...
1. **Introduction to Computer Science**
   ...
   - Resources:
     ...
     - [] [Practical Foundations for Programming Languages (Second Edition) by Robert Harper.](https://www.cs.cmu.edu/~rwh/pfpl.html)
...
2. **Mathematics for Computer Science**
   ...
   - [] [Calculus 1B: Integration](https://openlearninglibrary.mit.edu/courses/course-v1:MITx+18.01.2x+3T2019/courseware/getstarted/logistics-sequential/)
...
1. **Operating Systems**
   - [] Primary: [Operating Systems: Three Easy Pieces](https://github.com/Rmiddaugh10/computer-science/blob/master/coursepages/ostep/README.md)
   ...
   - Resources:
     ...
     - [] [K.N. King's C Programming: A Modern Approach](https://inria.hal.science/hal-02383654v2/file/modernC.pdf)
     - [] [cdecl: a tool to translate C gibberish into English](https://cdecl.org/)
     - [] [Ctrack on exercism.org](https://exercism.org/tracks/C)


2. **Algorithms & Data Structures**
   - [] Primary: [Divide and Conquer, Sorting and Searching, and Randomized Algorithms](https://www.coursera.org/learn/algorithms-divide-conquer)
